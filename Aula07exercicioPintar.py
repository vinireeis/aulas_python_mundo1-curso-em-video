altura = float(input('Vamos calcular a área, digite em metros a altura da'
                     'parede: '))
base = float(input('Agora, digite em metros o comprimento da parede: '))
area = base * altura
print('O tamanho da área é de {:.2f}m² e a quantidade de tinta necessária é '
      '{:.2f} litros.'.format(area, (area / 2)))
