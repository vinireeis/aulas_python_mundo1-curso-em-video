...
viagem = int(input('Informe qual a distância (em kilometros) da viagem que'
                   ' deseja fazer: '))
if viagem <= 200:
    custo = viagem * 0.50   # guardando o valor do custo em uma variável
    print('Sua passagem vai custar R${:.2f}.'.format(custo))
else:
    # fazendo o cálculo direto no format mas não guardando o valor da variável
    print('Sua passagem vai custar R${:.2f}.'.format(viagem * 0.45))
